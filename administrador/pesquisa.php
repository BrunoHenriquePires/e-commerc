...
<div class="container">
    ...
    <div class="botoes">
        ...
        <a href="administrador/adicionar_produto.php" class="btn">ADICIONAR PRODUTO</a>
...
<script>
    ...
    botaoAlterar.addEventListener('click', () => {
        if (idSelecionado.value) {
            window.location.href = 'administrador/alterar_produto.php?idProduto=' + idSelecionado.value;
        } else {
