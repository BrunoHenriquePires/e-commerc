...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['idUsuarioPermissao'])) {

    $idUsuario = intval($_POST['idUsuarioPermissao']);
    ...
    header("Location: pesquisa_usuario.php");
    exit;
}
?>
<!DOCTYPE html>
    ...
    <tr>
        ...
        <td>
            <?php if ($id != $idLogado): ?>
                <?php if ($codFuncionario): ?>
                    <form method="POST">
                        <input type="hidden" name="idUsuarioPermissao" value="<?= $id ?>">
                        <button class="btn">
...
<a href="usuario.php" class="voltar">VOLTAR</a>
