...
// Busca dados do usuário e cliente
$sql = "SELECT 
...
// Buscar endereço ligado ao cliente
$sqlEndereco = "
    SELECT Endereco.*
    FROM Cliente
...
$resEndereco = $conexao->query($sqlEndereco);
...
<div class="perfil-container">
    ...
    <?php if ($endereco && $endereco['rua']): ?>
        <p><strong>Rua:</strong> <?php echo $endereco['rua']; ?></p>
    ...
    <?php else: ?>
        <a href="endereco_form.php" class="logout-btn" style="background:#0275d8;">Cadastrar Endereço</a>
    <?php endif; ?>

    <?php if ($resFuncionario->num_rows > 0): ?>
        <a href="administrador/administrador.php" class="logout-btn">INÍCIO</a>
    <?php else: ?>
